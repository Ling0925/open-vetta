...
- `@vetta/runtime-node/codex-app-server`：开发者预览的 Codex 独占进程/协议适配器及 RuntimeHost Backend、关联目录与路由组合；尚未接入桌面选择器，见 [协议说明](../../docs/runtime/codex-app-server.md) 和 [后端接入](../../docs/runtime/codex-host-backend.md)
