...
try {
	...
	writeFileSync(
		...
		`${[
			...
			"Application conversations stay in the original store. Codex uses a managed data directory. Test in a disposable project; Codex permits workspace writes.",
			"Use the Native / Codex toggle beside the model selector in the existing conversation toolbar. Choose a configured Responses model.",
